...
AP_COLMIX_Latent __AP_COLMIX_PRIVATE_rgbToLatent(const float3 rgb, Texture2D c_table, const SamplerState samplerState)
{
    ...
    // 拿到对应在贴图中的位置
    const int2 pos  = int2(((i_rgb.b       % 16) * 256 + i_rgb.r    ), ((i_rgb.b       / 16) * 256 + i_rgb.g    ));
    const int2 pos1 = int2(((i_rgb.b       % 16) * 256 + i_rgb.r + 1), ((i_rgb.b       / 16) * 256 + i_rgb.g    ));
    const int2 pos2 = int2(((i_rgb.b       % 16) * 256 + i_rgb.r    ), ((i_rgb.b       / 16) * 256 + i_rgb.g + 1));
    const int2 pos3 = int2(((i_rgb.b       % 16) * 256 + i_rgb.r + 1), ((i_rgb.b       / 16) * 256 + i_rgb.g + 1));
    const int2 pos4 = int2((((i_rgb.b + 1) % 16) * 256 + i_rgb.r    ), (((i_rgb.b + 1) / 16) * 256 + i_rgb.g    ));
    const int2 pos5 = int2((((i_rgb.b + 1) % 16) * 256 + i_rgb.r + 1), (((i_rgb.b + 1) / 16) * 256 + i_rgb.g    ));
    const int2 pos6 = int2((((i_rgb.b + 1) % 16) * 256 + i_rgb.r    ), (((i_rgb.b + 1) / 16) * 256 + i_rgb.g + 1));
    const int2 pos7 = int2((((i_rgb.b + 1) % 16) * 256 + i_rgb.r + 1), (((i_rgb.b + 1) / 16) * 256 + i_rgb.g + 1));
